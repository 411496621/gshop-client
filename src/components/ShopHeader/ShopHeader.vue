  ...
  <div class="shop-header">
      ...
      <div class="shop-brief-modal" v-show="showBrief">
        <div class="brief-modal-content">
          ...
          <div class="mask-footer">
            <span class="iconfont icon-close" @click="showBrief=false"></span>
          </div>
        </div>
    ...
    <div class="activity-sheet" v-show="showSheet">
      <div class="activity-sheet-content">
        ...
        <ul class="list">
          <li class="activity-item" :class="colorClasses[support.type]" v-for="(support,index) in info.supports" :key="index">
            <span class="content-tag">
        ...
        <div class="activity-sheet-close">
          <span class="iconfont icon-close" @click="showSheet=false"></span>
        </div>
      </div>
...
<script>
  ...
  export default {
    data(){
      return {
        colorClasses:['activity-green','activity-red','activity-orange'],
        showBrief:false,
        showSheet:false
      }
    },
